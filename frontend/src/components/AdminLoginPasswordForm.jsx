...
const AdminLoginPasswordForm = ({ handleSubmit, passwordRef }) => {
    return (
        <div className='w-full h-screen bg-blue-100 flex items-center justify-center'>
            <div className='border-2 bg-white w-4/12 px-5 py-2 flex flex-col justify-between rounded-md'>
                <div className='py-4 pb-10 text-blue-500 text-center text-5xl'>Enter Password</div>
